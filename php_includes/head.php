<head>
    ...
    $stylesheet = "/css/style.css?version=" . date("s.", filemtime('css/style.css')) . date("s.", filemtime('css/tweets.css')) . date("s.", filemtime('css/tweets_grid.css')) . date("s.", filemtime('css/nav.css')) . date("s.", filemtime('css/profile.css')) . date("s", filemtime('css/quick_tweet.css'));
